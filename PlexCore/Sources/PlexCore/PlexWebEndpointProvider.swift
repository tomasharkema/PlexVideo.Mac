...
package final class PlexWebEndpointProvider: PlexWebEndpointProviderProtocol {
  ...
  package func provider() async -> PlexWebEndpointAPI {
    ...
    return PlexWebEndpointAPI(provider: provider)
  }
}

extension PlexWebEndpointAPIKey: DependencyKey {
  package static let liveValue: any PlexWebEndpointProviderProtocol = PlexWebEndpointProvider()
}
